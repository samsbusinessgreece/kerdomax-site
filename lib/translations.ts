...
export const translations = {
  ...
  el: {
    ...
    hero: {
      badge: 'Δεχόμαστε beta hosts — Μόνο Ελλάδα',
      ...
      cta1: 'Γίνε μέλος Beta — Δωρεάν',
      cta2: 'Δες Πώς Λειτουργεί',
      stats: [
        { num: '+28%', label: 'Μέση Αύξηση Εσόδων' },
        { num: '200K+', label: 'Ελληνικές Καταχωρήσεις' },
        { num: '€7B', label: 'Ετήσιος Όγκος Κρατήσεων' },
        { num: '3 λεπτά', label: 'Χρόνος Εγκατάστασης' },
      ],
    },
    features: {
      tag: 'Τι Κάνει το KERDOMAX',
    ...
    trust: {
      ...
      metrics: [
        { num: '+28%', label: 'Μέση αύξηση εσόδων' },
        { num: '3×', label: 'Ταχύτερη εγκατάσταση' },
        { num: '94%', label: 'Ερωτήματα αυτόματα' },
        { num: '€5B+', label: 'Αγορά για την οποία φτιάχτηκε' },
      ],
      testimonials: [
        {
